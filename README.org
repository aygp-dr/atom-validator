...
[[https://github.com/aygp-dr/atom-validator/actions/workflows/ci.yml][https://img.shields.io/github/actions/workflow/status/aygp-dr/atom-validator/ci.yml?branch=main&label=CI]]
...
#+begin_src clojure
{:deps {org.clojars.apace/atom-validator {:mvn/version "0.1.16"}}}
#+end_src

** Leiningen

#+begin_src clojure
[org.clojars.apace/atom-validator "0.1.16"]
#+end_src
